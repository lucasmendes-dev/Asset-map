                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <div class="w-full grid grid-cols-3 gap-4">
                        ...
                        <div class="bg-gray-700 rounded-lg p-4">
                            <h2 class="text-lg font-medium text-gray-900 dark:text-white">Total Money</h2>
                            <p class="text-xl font-semibold text-green-500">R$ {{ $totals[1] }}</p>
                        </div>
                    
                        <!-- Caixa 2 (no centro) -->
                        <div class="bg-gray-700 rounded-lg p-4">
                            <h2 class="text-lg font-medium text-gray-900 dark:text-white">Total Variation</h2>
                            <p class="text-xl font-semibold text-green-500">R$ {{ $totals[0] }}</p>
                        </div>
                    
                        <!-- Caixa 3 (à direita) -->
                        <div class="bg-gray-700 rounded-lg p-4">
                            <h2 class="text-lg font-medium text-gray-900 dark:text-white">Título 3</h2>
                            <p class="text-xl font-semibold text-red-500">R$ Valor 3</p>
                        </div>
                    </div>
